 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zi=new Map,$w=new Map,Ta=new Map;function Mu(e,t){try{e.container.addComponent(t)}catch(n){mn.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Oo(e){const t=e.name;if(Ta.has(t))return mn.debug(`There were multiple attempts to register component ${t}.`),!1;Ta.set(t,e);for(const n of zi.values())Mu(n,e);for(const n of $w.values())Mu(n,e);return!0}function Xh(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}function Lt(e){return e.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yo=Lw;function Qh(e,t={}){let n=e;typeof t!="object"&&(t={name:t});const r=Object.assign({name:Ea,automaticDataCollectionEnabled:!1},t),o=r.name;if(typeof o!="string"||!o)throw Mn.create("bad-app-name",{appName:String(o)});if(n||(n=qh()),!n)throw Mn.create("no-options");const i=zi.get(o);if(i){if(Bi(n,i.options)&&Bi(r,i.config))return i;throw Mn.create("duplicate-app",{appName:o})}const s=new U1(o);for(const a of Ta.values())s.addComponent(a);const l=new Nw(n,r,s);return zi.set(o,l),l}function Mw(e=Ea){const t=zi.get(e);if(!t&&e===Ea&&qh())return Qh();if(!t)throw Mn.create("no-app",{appName:e});return t}function _r(e,t,n){var r;let o=(r=Rw[e])!==null&&r!==void 0?r:e;n&&(o+=`-${n}`);const i=o.match(/\s|\//),s=t.match(/\s|\//);if(i||s){const l=[`Unable to register library "${o}" with version "${t}":`];i&&l.push(`library name "${o}" contains illegal characters (whitespace or "/")`),i&&s&&l.push("and"),s&&l.push(`version name "${t}" contains illegal characters (whitespace or "/")`),mn.warn(l.join(" "));return}Oo(new Ar(`${o}-version`,()=>({library:o,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jw="firebase-heartbeat-database",Bw=1,Ao="firebase-heartbeat-store";let Zs=null;function em(){return Zs||(Zs=tw(jw,Bw,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(Ao)}catch(n){console.warn(n)}}}}).catch(e=>{throw Mn.create("idb-open",{originalErrorMessage:e.message})})),Zs}async function zw(e){try{const n=(await em()).transaction(Ao),r=await n.objectStore(Ao).get(tm(e));return await n.done,r}catch(t){if(t instanceof Kn)mn.warn(t.message);else{const n=Mn.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});mn.warn(n.message)}}}async function ju(e,t){try{const r=(await em()).transaction(Ao,"readwrite");await r.objectStore(Ao).put(t,tm(e)),await r.done}catch(n){if(n instanceof Kn)mn.warn(n.message);else{const r=Mn.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});mn.warn(r.message)}}}function tm(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zo{constructor(t,n){this.shortDelay=t,this.longDelay=n,pn(n>t,"Short delay should be less than long delay!"),this.isMobile=S1()||T1()}get(){return Qw()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hu=new Map;function cn(e){pn(e instanceof Function,"Expected a class definition");let t=Hu.get(e);return t?(pn(t instanceof e,"Instance stored in cache mismatched with class"),t):(t=new e,Hu.set(e,t),t)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vk(e,t={}){return Zt(e,"GET","/v2/passwordPolicy",gn(e,t))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Dk(e,t){return Xo(e,"POST","/v1/accounts:signInWithPassword",gn(e,t))}async function km(e,t){return Zt(e,"POST","/v1/accounts:sendOobCode",gn(e,t))}async function Nk(e,t){return km(e,t)}async function Mk(e,t){return km(e,t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function jk(e,t){return Xo(e,"POST","/v1/accounts:signInWithEmailLink",gn(e,t))}async function Bk(e,t){return Xo(e,"POST","/v1/accounts:signInWithEmailLink",gn(e,t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Cr(e,t){return Xo(e,"POST","/v1/accounts:signInWithIdp",gn(e,t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ln extends Qo{constructor(){super("facebook.com")}static credential(t){return sr._fromParams({providerId:Ln.PROVIDER_ID,signInMethod:Ln.FACEBOOK_SIGN_IN_METHOD,accessToken:t})}static credentialFromResult(t){return Ln.credentialFromTaggedObject(t)}static credentialFromError(t){return Ln.credentialFromTaggedObject(t.customData||{})}static credentialFromTaggedObject({_tokenResponse:t}){if(!t||!("oauthAccessToken"in t)||!t.oauthAccessToken)return null;try{return Ln.credential(t.oauthAccessToken)}catch{return null}}}Ln.FACEBOOK_SIGN_IN_METHOD="facebook.com";Ln.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $n extends Qo{constructor(){super("twitter.com")}static credential(t,n){return sr._fromParams({providerId:$n.PROVIDER_ID,signInMethod:$n.TWITTER_SIGN_IN_METHOD,oauthToken:t,oauthTokenSecret:n})}static credentialFromResult(t){return $n.credentialFromTaggedObject(t)}static credentialFromError(t){return $n.credentialFromTaggedObject(t.customData||{})}static credentialFromTaggedObject({_tokenResponse:t}){if(!t)return null;const{oauthAccessToken:n,oauthTokenSecret:r}=t;if(!n||!r)return null;try{return $n.credential(n,r)}catch{return null}}}$n.TWITTER_SIGN_IN_METHOD="twitter.com";$n.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vk(e,t){return Xo(e,"POST","/v1/accounts:signUp",gn(e,t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _m(e,t,n=!1){if(Lt(e.app))return Promise.reject(fn(e));const r="signIn",o=await xm(e,r,t),i=await ar._fromIdTokenResponse(e,r,o);return n||await e._updateCurrentUser(i.user),i}async function Wk(e,t){return _m(vn(e),t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $m{constructor(t,n,r,o,i=!1){this.auth=t,this.resolver=r,this.user=o,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(t,n)=>{this.pendingPromise={resolve:t,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(t){const{urlResponse:n,sessionId:r,postBody:o,tenantId:i,error:s,type:l}=t;if(s){this.reject(s);return}const a={auth:this.auth,requestUri:n,sessionId:r,tenantId:i||void 0,postBody:o||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(a))}catch(c){this.reject(c)}}onError(t){this.reject(t)}getIdpTask(t){switch(t){case"signInViaPopup":case"signInViaRedirect":return vx;case"linkViaPopup":case"linkViaRedirect":return wx;case"reauthViaPopup":case"reauthViaRedirect":return yx;default:Et(this.auth,"internal-error")}}resolve(t){pn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(t),this.unregisterAndCleanUp()}reject(t){pn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(t),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`)},tC={root:function(t){var n=t.instance,r=t.props;return["p-inputtext p-component",{"p-filled":n.filled,"p-inputtext-sm":r.size==="small","p-inputtext-lg":r.size==="large","p-invalid":r.invalid,"p-variant-filled":r.variant?r.variant==="filled":n.$primevue.config.inputStyle==="filled"||n.$primevue.config.inputVariant==="filled","p-inputtext-fluid":n.hasFluid}]}},nC=pe.extend({name:"inputtext",theme:eC,classes:tC}),rC={name:"BaseInputText",extends:at,props:{modelValue:null,size:{type:String,default:null},invalid:{type:Boolean,default:!1},variant:{type:String,default:null},fluid:{type:Boolean,default:null}},style:nC,provide:function(){return{$pcInputText:this,$parentInstance:this}}},Is={name:"InputText",extends:rC,inheritAttrs:!1,emits:["update:modelValue"],inject:{$pcFluid:{default:null}},methods:{getPTOptions:function(t){var n=t==="root"?this.ptmi:this.ptm;return n(t,{context:{filled:this.filled,disabled:this.$attrs.disabled||this.$attrs.disabled===""}})},onInput:function(t){this.$emit("update:modelValue",t.target.value)}},computed:{filled:function(){return this.modelValue!=null&&this.modelValue.toString().length>0},hasFluid:function(){return ot(this.fluid)?!!this.$pcFluid:this.fluid}}},oC=["value","aria-invalid"];function iC(e,t,n,r,o,i){return x(),A("input",T({type:"text",class:e.cx("root"),value:e.modelValue,"aria-invalid":e.invalid||void 0,onInput:t[0]||(t[0]=function(){return i.onInput&&i.onInput.apply(i,arguments)})},i.getPTOptions("root")),null,16,oC)}Is.render=iC;const sC={class:"my-6 flex justify-between"},aC={class:"text-xl"},lC={class:"text-xl"},cC={class:"text-xs text-surface-500"},uC={class:"flex flex-col gap-4"},dC={key:0},fC={key:0,class:"flex flex-col"},hC={class:"text-surface-600"},mC={__name:"DatabaseEntityDetail",setup(e){const t=vs(),n=Ne({}),r=Wo(),o=Ko(),i=Ae(()=>Fl.models[r.params.entity]),s=yp();Uo(async()=>{n.value=await s.getDatabaseEntityDetail(r.params.entity,r.params.id)});const l=async()=>{await s.upsertDatabaseEntity(r.params.entity,r.params.id,n.value),t.add({severity:"success",summary:"Document updated",detail:"The database entry was saved successfully",life:3e3})},a=async()=>{await s.deleteDatabaseEntity(r.params.entity,r.params.id),t.add({severity:"success",summary:"Document removed",detail:"The database entry was deleted successfully",life:3e3}),o.push(`/${r.params.entity}`)};return(c,u)=>(x(),A(le,null,[E("div",sC,[E("div",aC,[E("h1",lC,Te(i.value.display_name)+" document ",1),E("span",cC,Te(Y(r).params.id),1)]),j(Y(Ve),{onClick:a,icon:"fa-solid fa-trash text-red-600",text:""})]),E("div",uC,[(x(!0),A(le,null,Er(i.value.fields,d=>(x(),A("div",null,[d&&n.value?(x(),A("div",dC,[d.type==="String"?(x(),A("div",fC,[E("label",hC,Te(d.fieldName),1),j(Y(Is),{modelValue:n.value[d.fieldName],"onUpdate:modelValue":f=>n.value[d.fieldName]=f},null,8,["modelValue","onUpdate:modelValue"])])):oe("",!0)])):oe("",!0)]))),256)),j(Y(Ve),{severity:"contrast",onClick:l,label:"Save"})])],64))}},pC={class:"flex flex-col gap-1"},bC={class:"flex gap-2 items-center"},gC=["for"],Rr={__name:"TextInput",props:{modelValue:{type:String,required:!0},label:{type:String,required:!0},identifier:{type:String,required:!0},icon:{type:String,required:!1},required:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1},inputType:{type:String,required:!0},placeholder:{type:String,required:!1}},emits:["update:modelValue"],setup(e,{emit:t}){const n=e,r=t,o=Ae({get(){return n.modelValue},set(i){r("update:modelValue",i)}});return(i,s)=>(x(),A("div",pC,[E("div",bC,[e.icon?(x(),A("i",{key:0,class:it([e.icon,"text-surface-400"])},null,2)):oe("",!0),E("label",{class:"text-surface-500 dark:text-surface-100 text-sm",for:e.identifier},Te(e.label),9,gC)]),j(Y(Is),{placeholder:e.placeholder,type:e.inputType,modelValue:o.value,"onUpdate:modelValue":s[0]||(s[0]=l=>o.value=l),"aria-describedby":e.identifier,disabled:e.disabled,required:e.required},null,8,["placeholder","type","modelValue","aria-describedby","disabled","required"])]))}},vC={class:"flex flex-col gap-6 mt-10 max-w-lg justify-center mx-auto"},yC={class:"flex justify-between"},wC={class:"text-surface-400"},kC={__name:"ProfileView",setup(e){const t=vs(),n=Bt(),r=Ne(!1),o=Ae(()=>n.user.photoURL?{image:n.user.photoURL}:{icon:"fa pi-user"}),i=Hn({email:n.user.email,name:n.user.displayName}),s=async()=>{r.value=!0;const a={displayName:i.name},c=await n.updateUserProfile(a);t.add(c),r.value=!1},l=Ae(()=>n.dateCreated.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}));return(a,c)=>(x(),A("div",vC,[E("div",yC,[j(Y(Ul),T(o.value,{image:Y(n).user.photoURL,size:"larger",shape:"circle"}),null,16,["image"]),E("div",null,[c[2]||(c[2]=E("h1",{class:"text-3xl text-right"},"My Account",-1)),E("small",wC,"Member since: "+Te(l.value),1)])]),E("form",{onSubmit:cs(s,["prevent"]),class:"flex flex-col gap-6 mt-10"},[j(Rr,{disabled:"",icon:"fa-solid fa-at",modelValue:i.email,"onUpdate:modelValue":c[0]||(c[0]=u=>i.email=u),identifier:"emailField",inputType:"email",label:"Email"},null,8,["modelValue"]),j(Rr,{modelValue:i.name,"onUpdate:modelValue":c[1]||(c[1]=u=>i.name=u),icon:"fa-solid fa-signature",identifier:"nameField",inputType:"text",label:"Full Name"},null,8,["modelValue"]),E("div",null,[j(Y(Ve),{type:"submit",icon:r.value?"fa-solid fa-spin fa-cog":"fa-solid fa-user-check",label:"Update Profile",size:"small",class:"flex gap-2 px-6"},null,8,["icon"])])],32)]))}};var xC=function(t){var n=t.dt;return`
...
`)},OC={root:function(t){var n=t.instance;return["p-inputgroup",{"p-inputgroup-fluid":n.hasFluid}]}},AC=pe.extend({name:"inputgroup",theme:PC,classes:OC}),LC={name:"BaseInputGroup",extends:at,props:{fluid:{type:Boolean,default:null}},style:AC,provide:function(){return{$pcInputGroup:this,$parentInstance:this}}},wp={name:"InputGroup",extends:LC,inheritAttrs:!1,inject:{$pcFluid:{default:null}},computed:{hasFluid:function(){return ot(this.fluid)?!!this.$pcFluid:this.fluid}}};function RC(e,t,n,r,o,i){return x(),A("div",T({class:e.cx("root")},e.ptmi("root")),[ye(e.$slots,"default")],16)}wp.render=RC;const $C={__name:"PasswordResetModal",setup(e){const t=Bt(),n=Ne(!1),r=Ne(""),o=Ne(!1),i=vs(),s=async()=>{o.value=!0;const l=await t.passwordReset(r.value);i.add(l),o.value=!1,n.value=!1};return(l,a)=>(x(),A(le,null,[E("span",{class:"text-right text-surface-600 dark:text-surface-50 text-xs hover:cursor-pointer hover:text-primary-700 hover:dark:text-surface-200",onClick:a[0]||(a[0]=c=>n.value=!0)},"Reset password"),j(Y(Vl),{visible:n.value,"onUpdate:visible":a[2]||(a[2]=c=>n.value=c),modal:"",header:"Reset Password",style:{width:"50rem"},breakpoints:{"1199px":"75vw","575px":"90vw"}},{default:be(()=>[E("form",{onSubmit:cs(s,["prevent"])},[a[3]||(a[3]=E("span",{class:"text-sm text-surface-500 dark:text-surface-200"},"Enter your email to reset your password",-1)),j(Y(wp),{class:""},{default:be(()=>[j(Y(Is),{type:"email",modelValue:r.value,"onUpdate:modelValue":a[1]||(a[1]=c=>r.value=c),placeholder:"joe@example.com",required:""},null,8,["modelValue"]),j(Y(Ve),{type:"submit",icon:o.value?"fa-solid fa-spin fa-cog":"fa-solid fa-key",severity:"warning"},null,8,["icon"])]),_:1})],32)]),_:1},8,["visible"])],64))}},DC={class:"flex flex-col gap-2 md:gap-6 mt-3 md:mt-10"},NC={key:0,class:"flex items-center gap-3 text-xs m-1 text-error"},MC={class:"text-xs text-surface-600 dark:text-surface-50"},jC={__name:"LoginComponent",setup(e){const t=Ne(!1),n=Wo(),r=Ko(),o=Bt(),i=Ae(()=>o.authErrorMessage),s=Ne({email:"",password:""});Uo(async()=>{n.query.redirect?r.push(n.query.redirect):r.push("/")});const l=async()=>{o.checkForAuthenticatedUser?(console.log("Login successful  😃"),n.query.redirect?r.push(n.query.redirect):r.push("/")):await o.getToken()&&(n.query.redirect?r.push(n.query.redirect):r.push("/"))},a=async()=>{console.log("logging in..."),t.value=!0,await o.signIn(s.value.email,s.value.password),await l(),t.value=!1},c=async()=>{t.value=!0,await o.googleSignIn(),await l(),t.value=!1};return(u,d)=>{const f=ze("router-link");return x(),A("div",DC,[d[7]||(d[7]=E("img",{src:ji,alt:"logo image",class:"mx-auto w-32 dark:invert"},null,-1)),E("form",{onSubmit:cs(a,["prevent"]),class:"flex flex-col gap-3 md:gap-6 md:mt-10"},[d[5]||(d[5]=E("div",{class:"flex items-center gap-3 text-surface-400 justify-center"},[E("i",{class:"fa-solid fa-user"}),E("h2",{class:"text-surface-400 text-center text-sm md:text-base font-display"},"Please login to continue")],-1)),j(Rr,{placeholder:"john@example.com",modelValue:s.value.email,"onUpdate:modelValue":d[0]||(d[0]=h=>s.value.email=h),identifier:"emailField",inputType:"email",label:"Email"},null,8,["modelValue"]),j(Rr,{placeholder:"Enter your password...",modelValue:s.value.password,"onUpdate:modelValue":d[1]||(d[1]=h=>s.value.password=h),identifier:"passwordField",inputType:"password",label:"Password"},null,8,["modelValue"]),j($C),E("div",null,[j(Y(Ve),{label:t.value?"Authenticating...":"Log in",type:"submit",class:"w-full",icon:`fa-solid ${t.value?"fa-solid fa-spin fa-cog":"fa-user"}`,size:"small"},null,8,["label","icon"]),i.value?(x(),A("div",NC,[d[2]||(d[2]=E("i",{class:"fa-solid fa-exclamation-circle"},null,-1)),E("span",null,Te(i.value),1)])):oe("",!0)]),E("span",MC,[d[4]||(d[4]=hn("Don't have an account? ")),j(f,{to:{name:"SignupView"},class:"font-bold hover:text-primary-700 dark:hover:text-primary-200"},{default:be(()=>d[3]||(d[3]=[hn("Sign up")])),_:1})])],32),j(Y(Jl),{type:"dotted",align:"center"},{default:be(()=>d[6]||(d[6]=[E("span",{class:"text-xs mx-2"},"or",-1)])),_:1}),j(Y(Ve),{onClick:c,label:"Continue with Google",type:"button",severity:"secondary",size:"small",outlined:"",icon:`${t.value?"fa-solid fa-spin fa-cog":"fa-brands fa-google"}`},null,8,["icon"])])}}},BC={class:"shadow rounded-lg md:shadow-xl md:rounded-xl outline outline-1 outline-surface-300 p-5 md:p-10 max-w-lg mx-auto md:m-10"},zC={__name:"LoginView",setup(e){return(t,n)=>(x(),A("div",BC,[j(jC)]))}},FC={class:"flex flex-col gap-3 md:gap-6 mt-2 md:mt-10"},UC={key:0,class:"flex items-center gap-3 text-xs m-1 text-error"},VC={key:1,class:"flex items-center gap-3 text-sm text-error"},HC={class:"text-xs text-surface-600 dark:text-surface-50"},KC={__name:"SignupComponent",setup(e){const t=Wo(),n=Ko(),r=Bt(),o=Ne(!1),i=Ne(null),s=Hn({email:"",password:""}),l=async()=>{r.checkForAuthenticatedUser?(console.log("Login successful  😃"),t.query.redirect?n.push(t.query.redirect):n.push("/")):await r.getToken()&&(t.query.redirect?n.push(t.query.redirect):n.push("/"))},a=async()=>{console.log(`Attempting to registering new user ${s.email}...`),o.value=!0,i.value=await r.emailSignUp(s.email,s.password),await l(),o.value=!1},c=async()=>{o.value=!0,await r.googleSignIn(),await l(),o.value=!1};return(u,d)=>{const f=ze("router-link");return x(),A(le,null,[d[8]||(d[8]=E("img",{src:ji,alt:"logo image",class:"mx-auto w-32 dark:invert"},null,-1)),E("form",{onSubmit:cs(a,["prevent"]),class:"flex flex-col gap-2 md:gap-6 mt-3 md:mt-10"},[d[7]||(d[7]=E("div",{class:"flex items-center gap-3 text-surface-400 justify-center"},[E("i",{class:"fa-solid fa-user-plus"}),E("h2",{class:"text-surface-400 text-center text-xs md:text-base font-display"},"Sign up for a new account")],-1)),E("div",FC,[j(Rr,{placeholder:"john@example.com",modelValue:s.email,"onUpdate:modelValue":d[0]||(d[0]=h=>s.email=h),identifier:"emailFieldsu",inputType:"email",label:"Email",required:""},null,8,["modelValue"]),j(Rr,{placeholder:"Choose a password...",modelValue:s.password,"onUpdate:modelValue":d[1]||(d[1]=h=>s.password=h),identifier:"passwordFieldsu",inputType:"password",label:"Password",required:""},null,8,["modelValue"]),j(Y(Ve),{label:"Register",icon:`fa-solid ${o.value?"fa-solid fa-spin fa-cog":"fa-user"}`,type:"submit",size:"small"},null,8,["icon"]),i.value?(x(),A("div",UC,[d[2]||(d[2]=E("i",{class:"fa-solid fa-exclamation-circle"},null,-1)),E("span",null,Te(i.value),1)])):oe("",!0),Y(r).authErrorMessage?(x(),A("div",VC,[d[3]||(d[3]=E("i",{class:"fa-solid fa-exclamation-circle"},null,-1)),E("span",null,Te(Y(r).authErrorMessage),1)])):oe("",!0),E("span",HC,[d[5]||(d[5]=hn("Already have an account? ")),j(f,{to:{name:"LoginView"},class:"font-bold hover:text-primary-700 dark:hover:text-primary-200"},{default:be(()=>d[4]||(d[4]=[hn("Log in")])),_:1})]),j(Y(Jl),{type:"dotted",align:"center"},{default:be(()=>d[6]||(d[6]=[E("span",{class:"text-xs mx-2"},"or",-1)])),_:1}),j(Y(Ve),{onClick:c,label:"Continue with Google",type:"button",severity:"secondary",size:"small",outlined:"",icon:"fa-brands fa-google"})])],32)],64)}}},WC={class:"shadow rounded-lg md:shadow-xl md:rounded-xl outline outline-1 outline-surface-300 p-5 md:p-10 max-w-lg mx-auto md:m-10"},qC={__name:"SignupView",setup(e){return(t,n)=>(x(),A("div",WC,[j(KC)]))}},GC={class:"flex items-center justify-center"},JC={class:"my-10 px-4 md:p-10 rounded-lg py-2 md:rounded-md md:shadow-xl bg-surface-50"},YC={class:"flex flex-col items-center"},ZC={__name:"NotFound404",setup(e){return(t,n)=>{const r=ze("router-link");return x(),A("div",GC,[E("div",JC,[E("div",YC,[n[0]||(n[0]=E("h1",{class:"font-bold text-primary-600 text-5xl"},"404",-1)),n[1]||(n[1]=E("p",{class:"mb-2 text-2xl font-bold text-center text-surface-800 md:text-3xl"}," Page not found ",-1)),n[2]||(n[2]=E("p",{class:"mb-8 text-center text-surface-500 md:text-lg"}," The page you're looking for doesn't exist. ",-1)),j(r,{to:"/"},{default:be(()=>[j(Y(Ve),{icon:"pi pi-backward",label:"Back to home"})]),_:1})])])])}}},kp=iy({history:Nv("/dashboard"),routes:[{path:"/",name:"HomeView",component:yI,meta:{requiresAuth:!0,requiresVerifiedEmail:!0}},{path:"/:entity",name:"DatabaseEntityIndex",component:QS,meta:{requiresAuth:!0}},{path:"/:entity/:id",name:"DatabaseEntityDetail",component:mC,meta:{requiresAuth:!0}},{path:"/auth",name:"AuthLayout",children:[{path:"login",name:"LoginView",component:zC},{path:"register",name:"SignupView",component:qC},{path:"profile",name:"ProfileView",component:kC}]},{path:"/:catchAll(.*)*",name:"NotFound404",component:ZC,meta:{requiresAuth:!0}}]});kp.beforeEach(async(e,t,n)=>{const r=Bt();if(r.user||await r.checkForAuthenticatedUser(),e.matched.some(s=>s.meta.requiresVerifiedEmail)&&r.user&&!r.user.emailVerified){r.setEmailVerificationModal(!0),n(!1);return}if(r.setEmailVerificationModal(!1),e.matched.some(s=>s.meta.requiresAuth)&&!r.user){n({name:"LoginView",query:{redirect:e.fullPath}});return}n()});const XC={css:`
    *[data-pd-ripple="true"]{
        overflow: hidden;
        position: relative;
    }
