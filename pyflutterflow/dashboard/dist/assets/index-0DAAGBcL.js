...
`)},eC={root:function(t){var n=t.instance,r=t.props;return["p-inputtext p-component",{"p-filled":n.filled,"p-inputtext-sm":r.size==="small","p-inputtext-lg":r.size==="large","p-invalid":r.invalid,"p-variant-filled":r.variant?r.variant==="filled":n.$primevue.config.inputStyle==="filled"||n.$primevue.config.inputVariant==="filled","p-inputtext-fluid":n.hasFluid}]}},tC=pe.extend({name:"inputtext",theme:QS,classes:eC}),nC={name:"BaseInputText",extends:at,props:{modelValue:null,size:{type:String,default:null},invalid:{type:Boolean,default:!1},variant:{type:String,default:null},fluid:{type:Boolean,default:null}},style:tC,provide:function(){return{$pcInputText:this,$parentInstance:this}}},Is={name:"InputText",extends:nC,inheritAttrs:!1,emits:["update:modelValue"],inject:{$pcFluid:{default:null}},methods:{getPTOptions:function(t){var n=t==="root"?this.ptmi:this.ptm;return n(t,{context:{filled:this.filled,disabled:this.$attrs.disabled||this.$attrs.disabled===""}})},onInput:function(t){this.$emit("update:modelValue",t.target.value)}},computed:{filled:function(){return this.modelValue!=null&&this.modelValue.toString().length>0},hasFluid:function(){return ot(this.fluid)?!!this.$pcFluid:this.fluid}}},rC=["value","aria-invalid"];function oC(e,t,n,r,o,i){return x(),A("input",T({type:"text",class:e.cx("root"),value:e.modelValue,"aria-invalid":e.invalid||void 0,onInput:t[0]||(t[0]=function(){return i.onInput&&i.onInput.apply(i,arguments)})},i.getPTOptions("root")),null,16,rC)}Is.render=oC;const iC={class:"my-6 flex justify-between"},sC={class:"text-xl"},aC={class:"text-xl"},lC={class:"text-xs text-surface-500"},cC={class:"flex flex-col gap-4"},uC={key:0},dC={key:0,class:"flex flex-col"},fC={class:"text-surface-600"},hC={__name:"DatabaseEntityDetail",setup(e){const t=vs(),n=Ne(null),r=Wo(),o=Ko(),i=Ae(()=>Fl.models[r.params.entity]),s=yp();Uo(async()=>{n.value=await s.getDatabaseEntityDetail(r.params.entity,r.params.id)});const l=async()=>{await s.updateDatabaseEntity(r.params.entity,r.params.id,n.value),t.add({severity:"success",summary:"Document updated",detail:"The database entry was saved successfully",life:3e3})},a=async()=>{await s.deleteDatabaseEntity(r.params.entity,r.params.id),t.add({severity:"success",summary:"Document removed",detail:"The database entry was deleted successfully",life:3e3}),o.push(`/${r.params.entity}`)};return(c,u)=>(x(),A(le,null,[E("div",iC,[E("div",sC,[E("h1",aC,Te(i.value.display_name)+" document ",1),E("span",lC,Te(Y(r).params.id),1)]),F(Y(We),{onClick:a,icon:"fa-solid fa-trash text-red-600"})]),E("div",cC,[(x(!0),A(le,null,Er(i.value.fields,d=>(x(),A("div",null,[d&&n.value?(x(),A("div",uC,[d.type==="String"?(x(),A("div",dC,[E("label",fC,Te(d.fieldName),1),F(Y(Is),{modelValue:n.value[d.fieldName],"onUpdate:modelValue":f=>n.value[d.fieldName]=f},null,8,["modelValue","onUpdate:modelValue"])])):re("",!0)])):re("",!0)]))),256)),F(Y(We),{severity:"contrast",onClick:l,label:"Save"})])],64))}},mC={class:"flex flex-col gap-1"},pC={class:"flex gap-2 items-center"},bC=["for"],Rr={__name:"TextInput",props:{modelValue:{type:String,required:!0},label:{type:String,required:!0},identifier:{type:String,required:!0},icon:{type:String,required:!1},required:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1},inputType:{type:String,required:!0},placeholder:{type:String,required:!1}},emits:["update:modelValue"],setup(e,{emit:t}){const n=e,r=t,o=Ae({get(){return n.modelValue},set(i){r("update:modelValue",i)}});return(i,s)=>(x(),A("div",mC,[E("div",pC,[e.icon?(x(),A("i",{key:0,class:it([e.icon,"text-surface-400"])},null,2)):re("",!0),E("label",{class:"text-surface-500 dark:text-surface-100 text-sm",for:e.identifier},Te(e.label),9,bC)]),F(Y(Is),{placeholder:e.placeholder,type:e.inputType,modelValue:o.value,"onUpdate:modelValue":s[0]||(s[0]=l=>o.value=l),"aria-describedby":e.identifier,disabled:e.disabled,required:e.required},null,8,["placeholder","type","modelValue","aria-describedby","disabled","required"])]))}},gC={class:"flex flex-col gap-6 mt-10 max-w-lg justify-center mx-auto"},vC={class:"flex justify-between"},yC={class:"text-surface-400"},wC={__name:"ProfileView",setup(e){const t=vs(),n=Bt(),r=Ne(!1),o=Ae(()=>n.user.photoURL?{image:n.user.photoURL}:{icon:"fa pi-user"}),i=Hn({email:n.user.email,name:n.user.displayName}),s=async()=>{r.value=!0;const a={displayName:i.name},c=await n.updateUserProfile(a);t.add(c),r.value=!1},l=Ae(()=>n.dateCreated.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}));return(a,c)=>(x(),A("div",gC,[E("div",vC,[F(Y(Ul),T(o.value,{image:Y(n).user.photoURL,size:"larger",shape:"circle"}),null,16,["image"]),E("div",null,[c[2]||(c[2]=E("h1",{class:"text-3xl text-right"},"My Account",-1)),E("small",yC,"Member since: "+Te(l.value),1)])]),E("form",{onSubmit:cs(s,["prevent"]),class:"flex flex-col gap-6 mt-10"},[F(Rr,{disabled:"",icon:"fa-solid fa-at",modelValue:i.email,"onUpdate:modelValue":c[0]||(c[0]=u=>i.email=u),identifier:"emailField",inputType:"email",label:"Email"},null,8,["modelValue"]),F(Rr,{modelValue:i.name,"onUpdate:modelValue":c[1]||(c[1]=u=>i.name=u),icon:"fa-solid fa-signature",identifier:"nameField",inputType:"text",label:"Full Name"},null,8,["modelValue"]),E("div",null,[F(Y(We),{type:"submit",icon:r.value?"fa-solid fa-spin fa-cog":"fa-solid fa-user-check",label:"Update Profile",size:"small",class:"flex gap-2 px-6"},null,8,["icon"])])],32)]))}};var kC=function(t){var n=t.dt;return`
